...
main() {
  ...
  CONTROLLER_PORT_WHITELIST="${CONTROLLER_PORT_WHITELIST:-}"
  ADMIN_API_WHITELIST="$(get_env_value ADMIN_API_WHITELIST)"
  ADMIN_API_WHITELIST="${ADMIN_API_WHITELIST:-}"
  ...
  LOG_ARCHIVE_WINDOW_HOURS="$(get_env_value LOG_ARCHIVE_WINDOW_HOURS)"
  LOG_ARCHIVE_WINDOW_HOURS="${LOG_ARCHIVE_WINDOW_HOURS:-24}"
  LOG_ARCHIVE_RETENTION_COUNT="$(get_env_value LOG_ARCHIVE_RETENTION_COUNT)"
  LOG_ARCHIVE_RETENTION_COUNT="${LOG_ARCHIVE_RETENTION_COUNT:-30}"
  LOG_ARCHIVE_DIR="$(get_env_value LOG_ARCHIVE_DIR)"
  ...
  SECURITY_AUTO_BLOCK_INTERVAL_SECONDS="${SECURITY_AUTO_BLOCK_INTERVAL_SECONDS:-60}"
  SECURITY_AUTO_BLOCK_WINDOW_SECONDS="$(get_env_value SECURITY_AUTO_BLOCK_WINDOW_SECONDS)"
  SECURITY_AUTO_BLOCK_WINDOW_SECONDS="${SECURITY_AUTO_BLOCK_WINDOW_SECONDS:-3600}"
  SECURITY_AUTO_BLOCK_THRESHOLD="$(get_env_value SECURITY_AUTO_BLOCK_THRESHOLD)"
  SECURITY_AUTO_BLOCK_THRESHOLD="${SECURITY_AUTO_BLOCK_THRESHOLD:-30}"
  SECURITY_AUTO_BLOCK_DURATION_SECONDS="$(get_env_value SECURITY_AUTO_BLOCK_DURATION_SECONDS)"
  SECURITY_AUTO_BLOCK_DURATION_SECONDS="${SECURITY_AUTO_BLOCK_DURATION_SECONDS:-3600}"
  SECURITY_AUTO_BLOCK_MAX_PER_INTERVAL="$(get_env_value SECURITY_AUTO_BLOCK_MAX_PER_INTERVAL)"
  SECURITY_AUTO_BLOCK_MAX_PER_INTERVAL="${SECURITY_AUTO_BLOCK_MAX_PER_INTERVAL:-5}"
